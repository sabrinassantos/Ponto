...
namespace Api.Service.Test.AutoMapper
{
    public class MunicipioMapper : BaseTesteService
    {
        ...
        public void E_Possivel_Mapear_os_Modelos_Municipio()
        {
            ...
            //Entity para Dto
            var userDto = Mapper.Map<RegistroDto>(entity);
            ...
            var userDtoCompleto = Mapper.Map<RegistroDtoCompleto>(listaEntity.FirstOrDefault());
            ...
            var listaDto = Mapper.Map<List<RegistroDto>>(listaEntity);
            ...
            var userDtoCreateResult = Mapper.Map<RegistroDtoCreateResult>(entity);
            ...
            var userDtoUpdateResult = Mapper.Map<RegistroDtoUpdateResult>(entity);
            ...
            var userDtoCreate = Mapper.Map<RegistroDtoCreate>(userModel);
            ...
            var userDtoUpdate = Mapper.Map<RegistroDtoUpdate>(userModel);
